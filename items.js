//DONT BEAUTIFY
var tier1 = [];
tier1.push(new Item("vanity", 1,"Ice Cream Machine",100, "sprites/ice_cream_machine.png"));
tier1.push(new thruster("propulsion", 1,"Fire Extinguisher",5, "sprites/fire_extinguisher.png", 0.1));
tier1.push(new Item("life_support", 1, "Oxygen Tank", 100, "sprites/oxygen.png"));
tier1.push(new Item("life_support", 1, "Refridgerator", 100, "sprites/fridge.png"));
tier1.push(new Item("fuel", 1, "Car Battery", 200, "sprites/car_battery.png"));

var tier2 = [];
tier2.push(new Item("life_support", 2,"Supply Crate",100, "sprites/Storage.png"));
tier2.push(new Item("fuel", 2,"Rocket Fuel Tank", 300, "sprites/rocket_fuel.png"));
tier2.push(new thruster("propulsion", 2,"Standard Thruster",10, "sprites/Thruster.png", 0.2));
tier2.push(new Item("vanity", 2, "Gold Bullion", 20, "sprites/gold_bullions.png"));
tier2.push(new Item("vanity", 2, "TV", 100, "sprites/tv.png"));

var tier3 = [];
tier3.push(new Item("life_support", 3,"Fabricator",100, "sprites/fabricator.png"));
tier3.push(new Item("fuel", 3,"Nuclear Generator",400, "sprites/nuclear_generator.png"));
tier3.push(new thruster("propulsion", 3,"Hyper Drive",20, "sprites/hyper_drive.png", 0.5));
tier3.push(new Item("vanity", 3, "Wi-Fi", 30, "sprites/wifi_strip15.png"));
tier3.push(new Item("vanity", 3, "Video Game Console", 30, "sprites/mii_u.png"));

var tier4 = [];
tier4.push(new thruster("propulsion", 4,"Alien Engine",25, "sprites/alien_drive.png", 1));
tier4.push(new Item("fuel", 4, "Alien Artifact", 600, "sprites/tessaract.png"));
tier4.push(new Item("vanity", 4, "Box of Kittens", 200, "sprites/cat_box_strip.png"));
